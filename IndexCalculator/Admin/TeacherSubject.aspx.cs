...
namespace IndexCalculator.Admin
{
    public partial class TeacherSubject : System.Web.UI.Page
    {
        ...
        private void GetClass()
        {
            ...
            ddlClass.DataBind();
            ddlClass.Items.Insert(0, "Seleccione la clase");
        }
        private void GetTeacher()
        {
            ...
            ddlTeacher.DataBind();
            ddlTeacher.Items.Insert(0, "Seleccione al profesor");
        }
        ...
        protected void ddlClass_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            ddlSubject.DataBind();
            ddlSubject.Items.Insert(0, "Seleccione la clase");
        }
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    lblMsg.Text = "Ya el <b>profesor</b> esta cursando esa materia!";
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                if ((e.Row.RowState & DataControlRowState.Edit) > 0)
                {
                    ...
                    ddlSubject.DataValueField = "SubjectId";
                    ddlSubject.DataBind();
                    ddlSubject.Items.Insert(0, "Seleccione la materia");
